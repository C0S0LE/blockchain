<script setup>
// import image_default_light from '@template/assets/img/generic/default-light.png';
// import image_default_dark from '@template/assets/img/generic/default-dark.png';
// import image_auto from '@template/assets/img/generic/auto.png';
// import image_top_default from '@template/assets/img/generic/top-default.png';
// import image_top_default_dark from '@template/assets/img/generic/top-default-dark.png';
// import image_nav_combo_light from '@template/assets/img/generic/nav-combo-light.png';
// import image_nav_combo_dark from '@template/assets/img/generic/nav-combo-dark.png';
// import image_dual_light from '@template/assets/img/generic/dual-light.png';
// import image_dual_dark from '@template/assets/img/generic/dual-dark.png';
// import image_vertical_darker from '@template/assets/img/generic/vertical-darker.png';
// import image_vertical_lighter from '@template/assets/img/generic/vertical-lighter.png';
// import image_top_slim from '@template/assets/img/generic/top-slim.png';
// import image_top_slim_dark from '@template/assets/img/generic/top-slim-dark.png';
// import image_top_style_darker from '@template/assets/img/generic/top-style-darker.png';
// import image_navbar_top_style_light from '@template/assets/img/generic/navbar-top-style-light.png';
// import image_top_style_lighter from '@template/assets/img/generic/top-style-lighter.png';
// import { onMounted, ref } from 'vue';
// import { Offcanvas } from 'bootstrap';
// import { useBootstrap } from '@/bootstrap/useBootstrap';

// const settingsOffcanvas = ref(null)
// const { initOffcanvases } = useBootstrap()
...
// const openSettings = () => {
//   if (settingsOffcanvas.value) {
//     const offcanvas = new Offcanvas(settingsOffcanvas.value)
//     offcanvas.show()
//   }
// }
</script>
...
<template>
  <!-- <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" :ref="el => settingsOffcanvas = el" tabindex="-1" aria-labelledby="settings-offcanvas">
    ...
    <div class="offcanvas-body scrollbar px-card" id="themeController">
        ...
        <div class="row gx-2">
          <div class="col-4">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight">
              <span class="mb-2 rounded d-block">
                <img class="img-fluid img-prototype mb-0" :src="image_default_light" alt=""/>
              </span>
          ...
          <div class="col-4">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark">
              <span class="mb-2 rounded d-block">
                <img class="img-fluid img-prototype mb-0" :src="image_default_dark" alt=""/>
              </span>
          ...
          <div class="col-4">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto">
              <span class="mb-2 rounded d-block">
                <img class="img-fluid img-prototype mb-0" :src="image_auto" alt=""/>
              </span>
      ...
      <div class="setting-panel-item">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionVertical">
              <span class="rounded d-block">
                <img class="img-fluid img-prototype d-dark-none" :src="image_default_light" alt=""/>
                <img class="img-fluid img-prototype d-light-none" :src="image_default_dark" alt=""/>
              </span>
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal">
              <span class="rounded d-block">
                <img class="img-fluid img-prototype d-dark-none" :src="image_top_default" alt=""/>
                <img class="img-fluid img-prototype d-light-none" :src="image_top_default_dark" alt=""/>
              </span>
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionCombo">
              <span class="rounded d-block">
                <img class="img-fluid img-prototype d-dark-none" :src="image_nav_combo_light" alt=""/>
                <img class="img-fluid img-prototype d-light-none" :src="image_nav_combo_dark" alt=""/>
              </span>
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionTopDouble">
              <span class="rounded d-block">
                <img class="img-fluid img-prototype d-dark-none" :src="image_dual_light" alt=""/>
                <img class="img-fluid img-prototype d-light-none" :src="image_dual_dark" alt=""/>
              </span>
        ...
        <p class="text-warning-dark font-medium">
          <span class="fa-solid fa-triangle-exclamation me-2 text-warning"></span>
        ...
        <div class="row gx-2">
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-dark">
              <img class="img-fluid img-prototype d-dark-none" :src="image_vertical_darker" alt="" />
              <img class="img-fluid img-prototype d-light-none" :src="image_vertical_lighter" alt="" />
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeDefault">
              <span class="mb-2 rounded d-block">
                <img class="img-fluid img-prototype d-dark-none mb-0" :src="image_top_default" alt=""/>
                <img class="img-fluid img-prototype d-light-none mb-0" :src="image_top_default_dark" alt=""/>
              </span>
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim">
              <span class="mb-2 rounded d-block">
                <img class="img-fluid img-prototype d-dark-none mb-0" :src="image_top_slim" alt=""/>
                <img class="img-fluid img-prototype d-light-none mb-0" :src="image_top_slim_dark" alt=""/>
              </span>
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault">
              <span class="mb-2 rounded d-block">
              <img class="img-fluid img-prototype d-dark-none mb-0" :src="image_top_default" alt=""/>
              <img class="img-fluid img-prototype d-light-none mb-0" :src="image_top_style_darker" alt=""/>
            </span>
              <span class="label-text">Default</span>
            </label>
          </div>
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker">
              <span class="mb-2 rounded d-block">
                <img class="img-fluid img-prototype d-dark-none mb-0" :src="image_navbar_top_style_light" alt=""/>
                <img class="img-fluid img-prototype d-light-none mb-0" :src="image_top_style_lighter" alt=""/>
              </span>
              <span class="label-text d-dark-none">Darker</span>
              <span class="label-text d-light-none">Lighter</span>
            </label>
  ...
  <a class="card setting-toggle" href="javascript:void(0)" @click="openSettings" data-bs-toggle="offcanvas">
